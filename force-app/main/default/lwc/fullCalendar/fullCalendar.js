...
export default class FullCalendarComponent extends NavigationMixin(
    LightningElement
) {
    calendar;
    ...
    @track calendarLabel = 'External Javascript Example   - FullCalendar';
        ...
        Promise.all([
            ...
            .then(() => {
                ...
                Promise.all([
                    ...
                    loadStyle(
                        this,
                        fullCalendar + '/packages/timegrid/main.css'
                    ),
                    loadScript(
                        this,
                    ...
                    loadScript(
                        this,
                        fullCalendar + '/packages/moment-timezone/main.js'
                    )
                ]).then(() => {
                    console.log('init');
                    this.init();
